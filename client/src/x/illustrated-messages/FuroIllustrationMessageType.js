...
const IllustrationMessageTypes = {
  ...
  /**
   * "NotFound404" illustration type.
   * @public
   * @type {404}
   */
  NotFound404: 'NotFound404',
  /**
   * "ProcessStart" illustration type.
   * @public
   * @type {ProcessCompleted}
   */
  ProcessStart: 'ProcessStart',
  /**
   * "ProcessCompleted" illustration type.
   * @public
   * @type {ProcessCompleted}
   */
  ProcessCompleted: 'ProcessCompleted',
  /**
   * "FatalServerError" illustration type.
   * @public
   * @type {FatalServerError}
   */
  FatalServerError: 'FatalServerError',
};
